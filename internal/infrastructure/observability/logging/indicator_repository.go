...
func NewIndicatorRepository(inner indicator.Repository, logger *zap.Logger, db string) *IndicatorRepository {
	if logger == nil {
		logger = zap.NewNop()
	}
	return &IndicatorRepository{inner: inner, logger: logger, db: db}
}

func (r *IndicatorRepository) Save(ctx context.Context, data ...indicator.StorageDTO) error {
	defer r.log(ctx, "indicators_save")()
...
func (r *IndicatorRepository) Find(
	...
	defer r.log(ctx, "indicators_find")()
...
func (r *IndicatorRepository) FindMany(
	...
	defer r.log(ctx, "indicators_find_many")()
...
func (r *IndicatorRepository) List(
	...
	defer r.log(ctx, "indicators_list")()
...
func (r *IndicatorRepository) Last(
	...
	defer r.log(ctx, "indicators_last")()
...
func (r *IndicatorRepository) DeleteOldRows(
	...
	defer r.log(ctx, "indicators_delete_old_rows")()
...
func (r *IndicatorRepository) ListUniq(ctx context.Context) ([]indicator.UniqDTO, error) {
	defer r.log(ctx, "indicators_list_uniq")()
...
func (r *IndicatorRepository) AllIndicatorInfo(ctx context.Context) (map[string][]indicator.IndicatorInfo, error) {
	defer r.log(ctx, "indicators_all_indicator_info_model")()
	return r.inner.AllIndicatorInfo(ctx)
}

func (r *IndicatorRepository) log(ctx context.Context, query string) func() {
	now := time.Now()
	return func() {
