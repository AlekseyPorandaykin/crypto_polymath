...
func init() {
	...
	viper.Set("logger.error_output_paths", []string{"./storage/logs/logger_error.log", "stdout"})
	viper.Set("logger.stacktrace", false)

	viper.Set("candlestick.logger.level", "INFO")
	viper.Set("candlestick.logger.output_paths", []string{"./storage/logs/candlestick_output.log", "stdout"})
	viper.Set("candlestick.logger.error_output_paths", []string{"./storage/logs/candlestick_error.log", "stdout"})
	viper.Set("candlestick.logger.stacktrace", false)

	viper.Set("analysis.logger.level", "INFO")
	viper.Set("analysis.logger.output_paths", []string{"./storage/logs/analysis_output.log", "stdout"})
	viper.Set("analysis.logger.error_output_paths", []string{"./storage/logs/analysis_error.log", "stdout"})
	viper.Set("analysis.logger.stacktrace", false)

	viper.Set("exchange.logger.level", "INFO")
	viper.Set("exchange.logger.output_paths", []string{"./storage/logs/exchange_output.log", "stdout"})
	viper.Set("exchange.logger.error_output_paths", []string{"./storage/logs/exchange_error.log", "stdout"})
	viper.Set("exchange.logger.stacktrace", false)

	viper.Set("indicator.logger.level", "INFO")
	viper.Set("indicator.logger.output_paths", []string{"./storage/logs/indicator_output.log", "stdout"})
	viper.Set("indicator.logger.error_output_paths", []string{"./storage/logs/indicator_error.log", "stdout"})
	viper.Set("indicator.logger.stacktrace", false)

	viper.Set("price.logger.level", "INFO")
	viper.Set("price.logger.output_paths", []string{"./storage/logs/price_output.log", "stdout"})
	viper.Set("price.logger.error_output_paths", []string{"./storage/logs/price_error.log", "stdout"})
	...
	viper.Set("http_client.logger.output_paths", []string{"./storage/logs/http_client_output.log", "stdout"})
	...
	viper.Set("bybit_sender.logger.output_paths", []string{"./storage/logs/bybit_sender_output.log", "stdout"})
	...
	viper.Set("calculator.logger.output_paths", []string{"./storage/logs/calculator_output.log", "stdout"})
	...
	viper.Set("rabbit_mq.addr", "0.0.0.0:5672")

	viper.Set("events.queue_candlestick", "candlesticks")
	viper.Set("events.queue_action", "actions")
	viper.Set("events.queue_indicator", "indicators")
	viper.Set("events.queue_analytic", "analytics")
	viper.Set("events.queue_candle_indicator", "candle_indicators")
}
