...
func init() {
	...
	viper.SetDefault("db_connection.host", "0.0.0.0")
	...
	viper.SetDefault("candlestick.storage.limit", 200)
	viper.SetDefault("indicator.storage.limit", 200)
	viper.SetDefault("analysis.storage.limit", 200)
	...
	viper.SetDefault("logger.logger.alert_level", "ERROR")
	...
	viper.SetDefault("loader.logger.level", "DEBUG")
	...
	viper.SetDefault("rabbit_mq.addr", "0.0.0.0:5672")
