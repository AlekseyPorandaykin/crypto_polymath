...
func init() {
	...
	viper.SetDefault("repository.logger.level", "ERROR")
	...
	viper.SetDefault("candlestick.logger.level", "ERROR")
	...
	viper.SetDefault("analysis.logger.level", "ERROR")
	...
	viper.SetDefault("exchange.logger.level", "ERROR")
	...
	viper.SetDefault("indicator.logger.level", "ERROR")
	...
	viper.SetDefault("price.logger.level", "ERROR")
	...
	viper.SetDefault("http_client.logger.level", "ERROR")
	...
	viper.SetDefault("bybit_sender.logger.level", "ERROR")
	...
	viper.SetDefault("loader.logger.level", "ERROR")
	...
	viper.SetDefault("calculator.logger.level", "ERROR")
	...
	viper.SetDefault("http_server.logger.level", "ERROR")
	...
	viper.SetDefault("indicator_handler.logger.level", "ERROR")
