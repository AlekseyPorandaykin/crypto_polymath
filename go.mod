...
require (
	github.com/AlekseyPorandaykin/crypto_loader v0.0.0-20250516054434-a2dc0fe69064
...
require (
	...
	github.com/mailslurp/mailslurp-client-go v0.0.0-20250511222314-a58231158193 // indirect
